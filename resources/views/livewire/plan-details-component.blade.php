<div class="container-xxl py-5">
                <div class="container">
                    <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s"
                        ...
                        <h1 class="mb-3">Subscription In {{$plan->name}} Plan</h1>
                    ...
                    <div class="row g-4">
                            ...
                            <div class="col-lg-10 col-md-10  offset-1 d-md-flex wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div class="team-item rounded overflow-hidden col-md-5 col-sm-12">
                                    <h5 style="color:#00B98E;" class="text-center p-4">Plan Featured </h5>
                                    <div class="p-4 mt-3 mb-0 pb-0">
                                            <h5 class="fw-bold mb-0 ml-3 lh-sm">
                                            <?php
                                                $lines = explode("<br>", Str::markdown($plan->description));
                                                ...
                                                <?php echo "<br>" ;?>
                                                    ...
                                                    <div class="col-10" >
                                                     <p style="line-height:35px;"><?php echo trim($line) ;?></p>
                                                    </div>
