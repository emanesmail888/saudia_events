        ...
        <div class="row g-0 gx-5 align-items-end">
            <div class="col-lg-6">
                <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                    ...
                    <p>All Events in <span class=" text-info">{{ $category_name}}</span>. in Saudia Arabia.</p>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp " data-wow-delay="0.1s">
                        <div class="property-item rounded overflow-hidden">
                            <div class="position-relative overflow-hidden">
                                ...
                                <div class="bg-primary rounded text-white position-absolute start-0 top-0 m-4 py-1 px-3">{{$event->category->name}}</div>
                                <div class="bg-white rounded-top text-primary position-absolute start-0 bottom-0 mx-4 pt-1 px-3">{{$event->event_type}}</div>
                            </div>
                            <div class="p-4 pb-0">
                                <h5 class="text-primary mb-3">{{$event->event_name}}</h5>
                                <a class="d-block h5 mb-2" href="">{{$event->start_date}}</a>
                                <p><i class="fa fa-map-marker-alt text-primary me-2"></i>{{$event->location}}</p>
                            </div>
