        ...
        <div class="row g-0 gx-5 align-items-end">
            <div class="col-lg-6">
                <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                    ...
                    <p>{{ __('strings.All Events in') }} <span class=" text-info">@if(app()->getLocale()=='ar'){{ strip_tags(htmlspecialchars_decode($category_name_ar)) }} @else{{ strip_tags(htmlspecialchars_decode($category_name)) }}@endif</span>.{{ __('strings.in Saudia Arabia') }} .</p>
                </div>
            </div>
