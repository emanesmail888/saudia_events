<div class="container">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body px-4 py-3 mb-8 bg-white rounded-lg shadow-md " >
                    ...
                    <form  enctype="multipart/form-data" wire:submit.prevent="storeEvent">
                     <div class="row g-3">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                        <input type="submit" value="{{ __('strings.Add Event') }}" class="btn btn-primary block w-100 py-3">
