             ...
             <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="price" placeholder="{{ __('strings.Service Price') }}" id="" class="block mt-1 w-full form-control" wire:model="price" />
                        ...
                        <label for="email">{{ __('strings.Price') }}</label>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="form-floating">
                        ...
                        @enderror
                        @if ($newImage)
                         <img src="{{$newImage->temporaryUrl()}}" style="width:150px; height:150px;" alt="">
                        @else
                         <img src="{{asset('assets/images/services')}}/{{$image}}" style="width:150px; height:150px;" alt="">
                ...
                <div class="col-12">
                    <input type="submit" value="{{ __('strings.Update Service') }}" class="btn btn-primary block w-100 py-3">
