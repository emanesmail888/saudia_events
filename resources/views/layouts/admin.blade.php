        ...
        <div class="container-fluid nav-bar bg-transparent">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-0 px-4">
                <a href="index.html" class="navbar-brand d-flex align-items-center text-center">
                    ...
                    <h1 class="m-0 text-primary">Events Around You</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    @else
                        ...
                        <a title="Register or Login" class="btn btn-primary mt-3 mb-3 pt-2 px-3 mr-2 d-block  d-lg-flex" href="{{route('login')}}">Login</a>
                        <a title="Register or Login" class="btn btn-primary mt-3 mb-3 pt-2 px-3 mr-2  d-block  d-lg-flex" href="{{route('register')}}">Register</a>
